...
# EMAIL_HOST_PASSWORD = 'xunqgctpgdpecmyl'  # Make sure this is the correct app password
# EMAIL_USE_TLS = True
# settings.py
...
DEFAULT_FROM_EMAIL = EMAIL_HOST_USER  # Ensure the default from email is set
